...
public class Tabla16 extends AppCompatActivity implements RateViewListener {
    ...
    public void onSwipe(boolean prav) {
        ...
        */
        ...
        if (prav) {
            //Continue button
            Intent serviceIntent= new Intent(Tabla16.this, Tracking.class);
            serviceIntent.putExtra("question_tabla16_true", 1);
            ...
            //Retry button
            Intent serviceIntent= new Intent(Tabla16.this, Tracking.class);
            serviceIntent.putExtra("question_tabla16_false", 1);
            startService(serviceIntent);
            Button continueButton = (Button) alertDialog.findViewById(R.id.button2345);
