...
public class Tabla19 extends AppCompatActivity implements RateViewListener {
    ...
    public void onSwipe(boolean prav) {
        ...
        */
        ...
        if (prav) {
            //Continue button
            Intent serviceIntent= new Intent(Tabla19.this, Tracking.class);
            serviceIntent.putExtra("question_tabla19_true", 1);
            ...
            //Retry button
            Intent serviceIntent= new Intent(Tabla19.this, Tracking.class);
            serviceIntent.putExtra("question_tabla19_false", 1);
            startService(serviceIntent);
            Button continueButton = (Button) alertDialog.findViewById(R.id.button2345);
